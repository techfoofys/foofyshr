...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { amount: @salary.amount, initial_amount_per_month: @salary.initial_amount_per_month, prov_period: @salary.prov_period, user_id: @salary.user_id } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { amount: @salary.amount, initial_amount_per_month: @salary.initial_amount_per_month, prov_period: @salary.prov_period, user_id: @salary.user_id } }
